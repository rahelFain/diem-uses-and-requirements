...
The contextual protections of physical emblems largely do not apply in the digital world. The following describes a number of characteristics that are either required or desirable for digital emblems. We list them as potential requirements. In some cases, a digital emblem could accompany a physical emblem to provide these additional properties.

Because there are multiple use cases for digital emblems, some of which are fundamentally different
from one another, it is not presumed that any one use of a digital emblem would have all or most of these requirements
...
incur specific security considerations. However, this document does not propose technical solutions; it enumerates  use cases that justify
